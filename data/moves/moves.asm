...
; Characteristics of each move.
	...
	move SHADOW_BALL, NO_ADDITIONAL_EFFECT,		80, GHOST,	100, 25
	move DRAIN_PUNCH, DRAIN_HP_EFFECT,		75, FIGHTING,	100, 25
	move JIGGLYPUFF_BLAST, OHKO EFFECT		 1, NORMAL,	100, 1
